...
export interface ICarClient {
    getCars(query: GetCarsQuery | null | undefined): Observable<Car[]>;
}

@Injectable({
    providedIn: 'root'
})
export class CarClient implements ICarClient {
...
export class Car implements ICar {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.imageResource = _data["imageResource"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["imageResource"] = this.imageResource;
        return data;
    }
}
...
export class GetCarsQuery implements IGetCarsQuery {

    constructor(data?: IGetCarsQuery) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetCarsQuery {
        data = typeof data === 'object' ? data : {};
        let result = new GetCarsQuery();
        result.init(data);
        return result;
    }
...
export interface IGetCarsQuery {
}
